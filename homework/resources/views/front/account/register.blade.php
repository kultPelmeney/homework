    ...
    <div class="container">
        <div class="row py-5 mt-4 align-items-center d-flex justify-content-between">
            ...
            <div class="col-md-5 pr-lg-5 mb-5 mb-md-0">
                <img src="./front/img/register.png" alt="" class="img-fluid mb-3 d-none d-md-block">
            </div>
                ...
                <form action="" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="text-center w-100">
                            <p class="text-muted font-weight-bold">Already Registered? <a href="./account/login" class="text-primary ml-2">Login</a></p>
                        </div>
